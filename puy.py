    ...
    try:
	 ...
	 if wait["Ghost"] == True:
		...
		cl.sendText(msg.to,"Kezia hereeeeee")
                ki.sendText(msg.to,"Keziaa hereeeee")
                kk.sendText(msg.to,"Keziaaa hereeeee")
                kc.sendText(msg.to,"Keziaaa hereeeee")
	        ...
	        if msg.from_ in Creator:                
              ...
              if wait["Tag"] == True:
                ...
                cl.sendText(msg.to,jawaban)
                    ...
                    puy = "Hi juga ka " +cl.getContact(msg.from_).displayName + "."
