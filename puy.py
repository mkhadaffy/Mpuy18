...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EoBjEbz2FZjq30iZRtC0.udjXm+oXWdAsPTVBgX3cWa.hy407VgovRx913X3Ra9YX9jpZwmC3Iu99OYihly9LWk=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='Eortelnf3mdSdlPbs1jd.+EjGmcOL1XSCj/yTns2vBq.ej6LytiYQQGmzX9u7PGXG1nKnT29bUhORHecnHpx6Lg=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
kk.login(token="EoajWdw4VLsLnoT4RM13.UAcSMqonILLriuREirzzuW.mq3gpNaL23w1MVP3eWEBzmlzSo4GrcbsEF7tgymoKec=")
kk.loginResult()
print "eaaaaaa\n"

kc = LINETCR.LINE()
kc.login(token="EoZRPfQwUvB95SlE4oke.cizeQqNnfxR0s20S26siJG.e9rV0P6nO3xnOAV8bmoM85Yqfx5Of6aOeTIotX06AQA=")
kc.loginResult()
print "eaaaaaaaaaa\n"

kr = LINETCR.LINE()
kr.login(token="EovVJKaIDW69kVVXRrM8./6IhiA909mDOlReutlH+Ea.N79N11K/kKkxx2+SNOMujDlz621XtysyGPNDVf5i03o=")
kr.loginResult()
print "eaaaaaaaaaaaaaaa\n"

ks = LINETCR.LINE()
ks.login(token="Eoa4VhjPqlwAOaaATIJd.NDTUuoFwHk9Lw62uGnNI3q.G24keUALsXi+Qx0ChtkbZvxkEL/nLCco/dfm78B2gV8=")
ks.loginResult()
print "eaaaaaaaaaaaaaaaaaaa\n"

kb = LINETCR.LINE()
kb.login(token="EoVWrFnj1ckpg3jNvSga.jCrCvL7g56Fi41uuVPsLwG.tvyyzu0jV28p73m37kMsng2Ga4K1mVsCZfeI1F+XzV8=")
kb.loginResult()
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
		...
		cl.sendText(msg.to,"Kezia hereeeeee")
                ki.sendText(msg.to,"Keziaa hereeee")
                kk.sendText(msg.to,"Keziaaa hereeee")
                kc.sendText(msg.to,"Keziaaaa hereeee")
                kr.sendText(msg.to,"Keziaaaaa hereeee")
                ks.sendText(msg.to,"Keziaaaaaa hereeee")
                ...
                kb.sendText(msg.to,responsename6)
