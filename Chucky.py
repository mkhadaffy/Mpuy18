...
wait = {
    ...
    "comment4":"Hi Rahma here, AutoLike by Puy\n\nhttp://line.me/ti/p/~yapuy",    
    "commentOn":True,
    "commentBlack":{},
    "message":"Thx For Add",    
    "blacklist":{},
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
		...
		cl.sendText(msg.to,"Kezia hereeeeee")
                ...
                kc.sendText(msg.to,"Rahma hereeeee")
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if wait["Tag"] == True:
                ...
                cl.sendText(msg.to,"Tuh Linknya Ka")
